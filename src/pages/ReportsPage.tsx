    ...
    <div className="space-y-6">
      ...
      {reportData && (
        <>
          ...
          {/* ════════════════════════════════════════════════
              SECTION 2 — PRINTABLE DASHBOARD (charts only)
          ════════════════════════════════════════════════ */}
          <div
          ...
          >
            ...
            <div className="p-5">
              ...
              {/* Legend */}
              <div className="mt-4 pt-3 border-t border-gray-200 flex flex-wrap gap-6 text-xs text-gray-600">
                <div>
                  <span className="font-bold text-gray-700">Escrita: </span>
                  PS = Pré-silábico &nbsp;|&nbsp; S = Silábico &nbsp;|&nbsp; SA = Sil.-Alfabético &nbsp;|&nbsp; A = Alfabético
                </div>
                <div>
                  <span className="font-bold text-gray-700">Leitura: </span>
                  NL = Não Leu &nbsp;|&nbsp; LP = Leu Palavras &nbsp;|&nbsp; LF = Leu Frases &nbsp;|&nbsp; LT = Leu Texto
